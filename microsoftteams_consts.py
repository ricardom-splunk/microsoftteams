...
MSTEAMS_MSGRAPH_CREATE_CHANNELS_ENDPOINT = '/teams/{group_id}/channels'
MSTEAMS_MSGRAPH_ADD_MEMBERS_TO_CHANNELS_ENDPOINT = '/teams/{group_id}/channels/{channel_id}/members'
...
MSTEAMS_JSON_DISPLAY_NAME = 'display_name'
